...
result=pydval.validator(key_word,data_input).matching()
i=0
for x in result:
    i=i+1
...
print("\t[*] Total Valid From Answer %s"%(len(pydval.validator(key_word,single_data1).matching())))
print("\t[*] Total Valid From Answer %s"%(len(pydval.validator(key_word,single_data2).matching())))
print("\t[*] Total Valid From Answer %s"%(len(pydval.validator(key_word,single_data3).matching())))
```
